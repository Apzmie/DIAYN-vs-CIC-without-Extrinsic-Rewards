...
class QueryNetwork(nn.Module):
    def __init__(self, z_dim, hidden_dim=256, embed_dim=64):
        super().__init__()
...
class KeyNetwork(nn.Module):
    def __init__(self, state_dim, hidden_dim=256, embed_dim=64):
        super().__init__()
...
class SACAgent:
    ...
    def cic_loss(self, state, next_state, z, temp=0.1):
        ...
        logits = torch.matmul(query, key.T) / temp
